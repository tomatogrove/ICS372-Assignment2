...
class VehicleXMLParserTest {
    ...
    private static final File READ_FILE_ONE = new File("./src/test/resources/Dealers.xml");
    private static final File READ_FILE_MULTI = new File("./src/test/resources/MultiDealers.xml");
